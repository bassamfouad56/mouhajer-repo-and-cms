...
const PARTNERS_DATA = [
  // Hospitality Partners
  {
    ...
    file: "partners/Marriott_International.png",
    category: "hospitality",
  },
  {
    name: "Ritz Carlton",
    file: "partners/1200px-RitzCarlton.svg.png",
    category: "hospitality",
  },
  {
    name: "Doubletree by Hilton",
    file: "partners/1200px-DoubletreeLogo.svg.png",
    category: "hospitality",
  },
  {
    name: "Radisson Blu",
    file: "partners/2880px-Radisson_Blu_logo.svg.png",
    category: "hospitality",
  },
  {
    name: "Sofitel JBR",
    file: "partners/Sofitel-JBR-Logo-2019-01_white.png",
    category: "hospitality",
  },
  {
    name: "Meydan Group",
    file: "partners/meydan-logo.png",
    category: "developers",
  },
  { name: "DMCC", file: "partners/DMCC-logo.png", category: "developers" },
  {
    name: "The Residences",
    file: "partners/The Residences.png",
    category: "developers",
  },
  ...
  {
    name: "Partner 12",
    file: "partners/Layer 816.png",
    category: "consultants",
  },
  {
    name: "Partner 13",
    file: "partners/Layer 817.png",
    category: "consultants",
  },
];
...
const TESTIMONIALS_DATA = [
  {
    ...
    quote:
      "MIDC transformed our Palm Jumeirah villa into a masterpiece. Their attention to detail and ability to execute complex designs while maintaining quality is unmatched in the UAE.",
    rating: 5,
  ...
  },
  {
    ...
    quote:
      "The Sheraton Abu Dhabi renovation was completed on time, on budget, and without a single guest complaint. Their ability to work in live environments while maintaining 5-star service standards is remarkable.",
    rating: 5,
    category: "hospitality",
    featured: true,
  },
  {
    ...
    quote:
      "Our DIFC headquarters reflects the premium image we wanted to project. From the custom joinery to the MEP systems, everything was handled professionally by one team.",
    rating: 5,
    category: "commercial",
    featured: true,
  },
  {
    ...
    quote:
      "The clinic fit-out met all DHA requirements perfectly. MIDC understood healthcare compliance and delivered infection-controlled spaces that passed inspection on the first try.",
    rating: 5,
    category: "commercial",
    featured: true,
  },
  {
    ...
    quote:
      "Working with MIDC on our lobby renovation was seamless. They managed everything from design to execution, and their in-house manufacturing capability meant custom pieces arrived exactly as specified.",
    rating: 5,
    category: "hospitality",
    featured: true,
  },
  {
    ...
    quote:
      "From the initial concept to the final walkthrough, MIDC exceeded every expectation. Our villa is featured in design magazines, and we couldn't be prouder of our home.",
    rating: 5,
    category: "residential",
    featured: true,
  },
...
const SITE_SETTINGS = {
  ...
  companyDescriptionEn:
    "MIDC is a vertically integrated design and construction firm specializing in luxury hospitality, residential, and commercial projects across the UAE.",
  companyDescriptionAr:
    "شركة موحاجر الدولية للتصميم والمقاولات هي شركة متكاملة رأسياً متخصصة في مشاريع الضيافة الفاخرة والسكنية والتجارية في جميع أنحاء الإمارات.",
  foundingYear: 2009,
  ...
  stats: [
    ...
    },
    {
      value: 15000,
      suffix: "",
      labelEn: "Sqft Factory",
      labelAr: "قدم مربع مصنع",
    },
    {
      value: 100,
      suffix: "%",
      labelEn: "In-House Capability",
      labelAr: "قدرة داخلية",
    },
  ],
  ...
  certifications: [
    {
      ...
      detail: "International standard for quality management",
    },
    {
      name: "ISO 14001:2015",
      description: "Environmental Management",
      detail: "International standard for environmental management",
    },
    {
      name: "ISO 45001:2018",
      description: "Occupational Health & Safety",
      detail: "International standard for OH&S management",
    },
  ],

  // SEO
  defaultSeoTitle:
    "Mouhajer International Design | Luxury Interior Design Dubai",
  defaultSeoDescription:
    "Premium interior design, construction, and fit-out services in Dubai and Abu Dhabi. From concept to handover, one team handles everything.",
};
...
async function seedSiteSettings(): Promise<void> {
  ...
  if (fs.existsSync(founderDir)) {
    ...
    if (founderFiles.length > 0) {
      ...
      if (assetId) {
        settings.founderImage = createImageRef(
          assetId,
          "Eng. Maher Mouhajer - CEO & Founder"
        );
        console.log(" ✓");
      }
    }
...
async function checkBrokenImages(): Promise<void> {
  ...
  if (projectsWithoutImages.length > 0) {
    console.log(
      `  ⚠️  ${projectsWithoutImages.length} projects without mainImage:`
    );
    projectsWithoutImages
      .slice(0, 5)
      .forEach((p: any) => console.log(`     - ${p.title}`));
  ...
  if (servicesWithoutImages.length > 0) {
    console.log(
      `  ⚠️  ${servicesWithoutImages.length} services without mainImage:`
    );
...
async function main() {
  ...
  if (!process.env.SANITY_API_TOKEN) {
    ...
    console.log(
      'Usage: SANITY_API_TOKEN="your-token" npx tsx scripts/seed-complete-content.ts'
    );
    process.exit(1);
  }
