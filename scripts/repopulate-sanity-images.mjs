...
function findAssetByPattern(assets, pattern) {
  const asset = assets.find(
    (a) =>
      a.originalFilename &&
      a.originalFilename.toLowerCase().includes(pattern.toLowerCase())
  );
  if (asset) {
...
async function main() {
  ...
  for (const mapping of industryMappings) {
    ...
    const success = await updateDocumentImage(
      mapping.id,
      "mainImage",
      imageRef
    );
  ...
  const serviceMappings = [
    ...
    {
      id: "service-fit-out-execution",
      name: "Fit-Out & Execution",
      pattern: "sheratonAD01",
    },
  ...
  const postMappings = [
    ...
    {
      id: "post-anatomy-winner-2025",
      name: "Anatomy of a Winner",
      pattern: "sofiteljbr10",
    },
    {
      id: "post-blame-game-turnkey",
      name: "Blame Game Turnkey",
      pattern: "officeC105",
    },
    {
      id: "post-sound-of-luxury",
      name: "Sound of Luxury",
      pattern: "penthouse01",
    },
  ];
  ...
  const projectMappings = [
    {
      id: "project-closet-dressing-room-design",
      name: "Closet Dressing Room",
      pattern: "villa15x14",
    },
    {
      id: "project-sheraton-abu-dhabi-renovation",
      name: "Sheraton Abu Dhabi",
      pattern: "sheratonAD01",
    },
    {
      id: "project-modern-office-fitout-dubai",
      name: "Modern Office Fitout",
      pattern: "officeC101",
    },
    {
      id: "bsdaB5yTTfnN2hUF2L6DpF",
      name: "Project from batch 2",
      pattern: "askim01",
    },
    {
      id: "bsdaB5yTTfnN2hUF2L6Eye",
      name: "Project from batch 2",
      pattern: "prince01",
    },
  ];
  ...
  const awardMappings = [
    {
      id: "Zuxbdi1Wl3DApzNzfEv8xJ",
      name: "Best Residential Interior",
      pattern: "villa15x05",
    },
    {
      id: "xVnPuN5l3oZUVWqysm0o0Y",
      name: "Best Hotel Interior",
      pattern: "ritzcarl05",
    },
  ];
