...
const CATEGORY_IMAGES = {
  'design-trends': 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80',
  'project-stories': 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80',
  'materials-craft': 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80',
  'engineering': 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=800&q=80',
  'founders-insights': 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&q=80',
  'behind-the-scenes': 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80',
};
...
async function updatePosts() {
  ...
  for (const post of posts) {
    ...
    // Add image if needed
    if (needsImage) {
      const imageUrl = CATEGORY_IMAGES[newCategory] || CATEGORY_IMAGES['project-stories'];
...
async function main() {
  ...
  try {
    ...
    console.log('The journal URLs will now use slugs like /journal/design-trends/post-slug');
  } catch (error) {
    console.error('\n❌ Script failed:', error);
    process.exit(1);
  }
