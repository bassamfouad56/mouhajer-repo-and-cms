...
const SANITY_PROJECT_ID = "b6q28exv";
...
const industries = [
  {
    ...
    description: {
      en: "Hotels, resorts, restaurants and entertainment venues",
      ar: "الفنادق والمنتجعات والمطاعم وأماكن الترفيه",
    },
  },
  {
    id: "residential",
    ...
    description: {
      en: "Luxury villas, apartments and private homes",
      ar: "الفيلات الفاخرة والشقق والمنازل الخاصة",
    },
  },
  {
    id: "commercial",
    ...
    description: {
      en: "Offices, headquarters and corporate spaces",
      ar: "المكاتب والمقرات الرئيسية ومساحات الشركات",
    },
  },
  {
    id: "healthcare",
    ...
    description: {
      en: "Clinics, hospitals and wellness centers",
      ar: "العيادات والمستشفيات ومراكز العافية",
    },
  },
  {
    id: "retail",
    ...
    description: {
      en: "Showrooms, boutiques and shopping destinations",
      ar: "صالات العرض والمتاجر ووجهات التسوق",
    },
  },
];
...
const locations = [
  ...
  {
    id: "downtown-dubai",
    name: { en: "Downtown Dubai", ar: "داون تاون دبي" },
    country: "UAE",
  },
  {
    id: "dubai-marina",
...
const services = [
  {
    ...
    excerpt:
      "Comprehensive interior design services from concept to completion, creating spaces that inspire and function beautifully.",
    icon: "Palette",
    order: 1,
    features: [
      {
        ...
        description:
          "Creating unique design concepts tailored to your vision and lifestyle.",
      },
      {
        title: "Space Planning",
        description:
          "Optimizing layouts for functionality, flow, and aesthetic appeal.",
      },
      {
        title: "Material Selection",
        description:
          "Curating premium materials, finishes, and color palettes.",
      },
      {
        title: "3D Visualization",
        description: "Bringing designs to life with photorealistic renderings.",
      },
    ],
  },
  {
    ...
    excerpt:
      "Complete turnkey fit-out services delivering exceptional quality and precision in every detail.",
    icon: "Wrench",
    order: 2,
    features: [
      {
        ...
        description:
          "Expert oversight ensuring timely delivery and budget control.",
      },
      {
        title: "Construction",
        description: "High-quality construction and finishing works.",
      },
      {
        title: "MEP Works",
        description:
          "Complete mechanical, electrical, and plumbing installations.",
      },
      {
  ...
  },
  {
    ...
    slug: "custom-joinery",
    excerpt:
      "Bespoke joinery and millwork crafted with precision and attention to detail.",
    icon: "Hammer",
    order: 3,
    features: [
      {
        title: "Custom Furniture",
        description: "One-of-a-kind pieces designed for your space.",
      },
      {
        title: "Built-in Solutions",
        description:
          "Seamlessly integrated storage and architectural elements.",
      },
      {
        title: "Premium Materials",
        description: "Finest woods and materials from around the world.",
      },
      {
  ...
  },
  {
    ...
    excerpt:
      "Creating memorable hospitality experiences through thoughtful design of hotels, restaurants, and entertainment venues.",
    icon: "Hotel",
    order: 4,
    features: [
      {
        title: "Hotel Design",
        description: "Luxurious guest experiences from lobby to suite.",
      },
      {
        title: "Restaurant Design",
        description:
          "Atmospheric dining environments that enhance culinary experiences.",
      },
      {
        title: "Spa & Wellness",
        description: "Tranquil spaces promoting relaxation and wellbeing.",
      },
      {
        title: "Brand Integration",
        description: "Design that reflects and elevates brand identity.",
      },
    ],
  },
  {
    ...
    excerpt:
      "Innovative workspace design that boosts productivity, collaboration, and employee wellbeing.",
    icon: "Building2",
    order: 5,
    features: [
      {
        title: "Corporate Headquarters",
        description: "Prestigious headquarters reflecting company culture.",
      },
      {
        title: "Open Plan Offices",
        description: "Collaborative workspaces fostering innovation.",
      },
      {
        title: "Executive Suites",
        description: "Sophisticated private offices and boardrooms.",
      },
      {
        title: "Wellness Spaces",
        description: "Break areas and amenities supporting employee wellbeing.",
      },
    ],
  },
  {
    ...
    excerpt:
      "Photorealistic 3D renderings and virtual tours bringing your designs to life before construction begins.",
    icon: "Box",
    order: 6,
    features: [
      {
        title: "Photorealistic Renders",
        description: "Ultra-realistic visualizations of your future space.",
      },
      {
        title: "360° Virtual Tours",
        description: "Immersive walkthroughs from any device.",
      },
      {
        title: "Animation",
        description: "Dynamic flythroughs showcasing design flow.",
      },
      {
        title: "Design Options",
        description: "Compare multiple design directions side by side.",
      },
    ],
  },
];
...
const projects = [
  {
    ...
    excerpt: {
      en: "Elegant bathroom design featuring premium marble finishes, custom vanities, and sophisticated lighting.",
      ar: "تصميم حمام أنيق يتميز بتشطيبات رخام فاخرة وخزائن مخصصة وإضاءة راقية.",
    },
  ...
  },
  {
    ...
    title: {
      en: "Villa Hatem Master Bedroom Suite",
      ar: "جناح غرفة النوم الرئيسية - فيلا حاتم",
    },
    excerpt: {
      en: "Opulent master bedroom design featuring bespoke headboard, custom lighting, and premium textiles.",
      ar: "تصميم غرفة نوم رئيسية فاخرة بلوح رأسي مخصص وإضاءة مميزة ومنسوجات فاخرة.",
    },
    category: "residential",
    location: "dubai",
    projectType: "villa",
  ...
  },
  {
    ...
    title: {
      en: "Modern Bedroom Interior - Ajman Villa",
      ar: "تصميم غرفة نوم عصرية - فيلا عجمان",
    },
    excerpt: {
      en: "Contemporary bedroom design with clean lines, natural light optimization, and modern amenities.",
      ar: "تصميم غرفة نوم معاصر بخطوط نظيفة وإضاءة طبيعية مثالية ومرافق حديثة.",
    },
    category: "residential",
    location: "ajman",
    projectType: "villa",
  ...
  },
  {
    ...
    title: {
      en: "Premium Commercial Interior Fit-out",
      ar: "تجهيز داخلي تجاري فاخر",
    },
    excerpt: {
      en: "High-end commercial space design featuring sophisticated finishes and optimal space planning.",
      ar: "تصميم مساحة تجارية راقية بتشطيبات فخمة وتخطيط مساحات مثالي.",
    },
    category: "commercial",
    location: "dubai",
    projectType: "office",
  ...
  },
  {
    ...
    excerpt: {
      en: "Contemporary office fit-out featuring ergonomic workstations and collaborative zones.",
      ar: "تجهيز مكتب معاصر بمحطات عمل مريحة ومناطق تعاونية.",
    },
    category: "commercial",
    location: "dubai",
    projectType: "office",
  ...
  },
  {
    ...
    excerpt: {
      en: "Complete turnkey residential fit-out from design concept to final handover with premium finishes.",
      ar: "تجهيز سكني متكامل من مفهوم التصميم إلى التسليم النهائي بتشطيبات فاخرة.",
    },
    category: "residential",
    location: "dubai",
  ...
  },
  {
    ...
    title: {
      en: "Luxury Closet & Dressing Room",
      ar: "غرفة ملابس وخزانة فاخرة",
    },
    excerpt: {
      en: "Custom walk-in closet design with premium organization systems and elegant finishes.",
      ar: "تصميم خزانة ملابس مخصصة بأنظمة تنظيم فاخرة وتشطيبات أنيقة.",
    },
    category: "residential",
    location: "dubai",
    projectType: "villa",
...
async function createSiteSettings() {
  ...
  try {
    await client.createOrReplace({
      ...
      founderQuote:
        "We transform visions into extraordinary spaces that inspire, comfort, and endure.",
      defaultSeoTitle:
        "Mouhajer International Design | Premium Interior Design Dubai",
      defaultSeoDescription:
        "Leading interior design and fit-out company in Dubai and UAE. Luxury residential, hospitality, and commercial spaces crafted with excellence since 2008.",
    });
