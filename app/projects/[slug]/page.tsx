...
export function getPlaceholderProjects(): Project[] {
  return [
    {
      id: '1',
      ...
      acfFields: {
        ...
        year: '2023',
        description: 'A transformative hospitality project spanning 50,000 square meters of luxury resort design. The Sheraton Abu Dhabi combines world-class amenities with stunning architectural design, creating a premier destination for international travelers seeking the ultimate in beachfront luxury.',
        gallery: [
          {
    ...
    },
    {
      ...
      acfFields: {
        ...
        location: 'Dubai, UAE',
        year: '2024',
        description: 'An 800-square-meter penthouse transformation featuring bespoke design elements, smart home integration, and unparalleled attention to detail.',
        gallery: [
          {
    ...
    },
    {
      ...
      acfFields: {
        ...
        location: 'DIFC, Dubai',
        year: '2023',
        description: 'A complete reimagining of 3,000 square meters of corporate office space, focusing on employee experience, sustainability, and brand expression.',
        gallery: [
          {
...
export default async function ProjectPage({ params }: { params: { slug: string } }) {
  ...
  if (!project) {
    ...
    project = placeholderProjects.find(p => p.slug === params.slug) || null;
  }
