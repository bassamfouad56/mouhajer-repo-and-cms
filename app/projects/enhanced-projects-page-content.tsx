      ...
      <div className="flex flex-col justify-center py-8">
        ...
        {project.acfFields?.description && (
          <p className="mb-8 text-lg font-light leading-relaxed text-neutral-600">
            {project.acfFields.description.substring(0, 200)}...
          </p>
        )}
...
const placeholderProjects: Project[] = [
  {
    ...
    acfFields: {
      ...
      year: '2023',
      description: 'A transformative hospitality project spanning 50,000 square meters of luxury resort design.',
      gallery: [],
    },
  },
  {
    ...
    acfFields: {
      ...
      location: 'Dubai, UAE',
      year: '2024',
      description: 'An 800-square-meter penthouse transformation featuring bespoke design elements.',
      gallery: [],
    },
  },
  {
    ...
    acfFields: {
      ...
      location: 'DIFC, Dubai',
      year: '2023',
      description: 'Complete reimagining of 3,000 square meters of corporate office space.',
      gallery: [],
    },
  },
];
