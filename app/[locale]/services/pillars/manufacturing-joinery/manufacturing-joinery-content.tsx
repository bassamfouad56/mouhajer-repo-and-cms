  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <SafeImage
          src="/projects/turnkey-design-fitout/_MID2440-HDR.jpg"
        ...
        <div className="grid gap-16 lg:grid-cols-12 lg:gap-20">
          ...
          >
            <div className="relative aspect-4/5 overflow-hidden">
              <SafeImage
                src="/projects/turnkey-design-fitout/_MID2462-HDR.jpg"
...
function Section2() {
  ...
  const capabilities = [
    ...
    },
    {
      ...
      image: '/projects/turnkey-design-fitout/_MID2491-HDR.jpg',
      items: [
        {
