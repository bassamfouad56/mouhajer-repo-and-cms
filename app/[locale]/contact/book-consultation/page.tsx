...
const locationOptions = ['Dubai', 'Abu Dhabi', 'International (Doha/London/Syria)'];
const budgetOptions = ['1M - 5M AED', '5M - 20M AED', '20M - 50M AED', '50M+ (Framework Contract)'];
const timelineOptions = ['Immediate Start', 'Within 3 Months', 'Planning Stage (6+ Months)'];
...
export default function BookConsultationPage() {
  ...
  const validateStep = async (step: number) => {
    ...
    if (step === 1) {
      fieldsToValidate = ['fullName', 'role', 'email', 'phone', 'meetingLocation'];
    } else if (step === 2) {
      fieldsToValidate = ['projectCategory', 'scopeOfWork', 'projectStatus', 'location', 'isTender'];
    }
  ...
  const steps = [
    ...
    { number: 2, title: 'The Asset', subtitle: 'Project Details', icon: Building2 },
    { number: 3, title: 'The Ambition', subtitle: 'Budget & Style', icon: Sparkles },
  ];
          ...
          <div className="mx-auto max-w-5xl px-6">
            ...
            >
              <h2 className="mb-6 font-Playfair text-3xl font-light leading-tight text-neutral-950 md:text-4xl">
                This is More Than a Meeting.<br />
                <span className="text-neutral-500">It is a Feasibility Study.</span>
              </h2>
              <p className="mx-auto max-w-2xl text-base font-light leading-relaxed text-neutral-600">
                At MIDC, we value your time. Our initial consultation is designed to provide you with
                actionable insights, not just a sales pitch. By sharing the details of your project
                below, you allow our engineering and design teams to prepare a preliminary analysis.
              </p>
            </motion.div>
                    ...
                    {currentStep === 1 && (
                      ...
                      >
                        <div className="mb-8 border-b border-neutral-100 pb-6">
                          ...
                          <p className="mt-2 text-sm text-neutral-500">Basic Contact Information</p>
                        </div>
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                          ...
                          <div>
                            ...
                            <select
                              ...
                              className={`w-full rounded-lg border ${
                                errors.meetingLocation ? 'border-red-300' : 'border-neutral-200'
                              } bg-neutral-50 px-4 py-3 text-base font-light text-neutral-950 transition-all focus:border-neutral-400 focus:bg-white focus:outline-none`}
                            >
                    ...
                    {currentStep === 2 && (
                      ...
                      >
                        <div className="mb-8 border-b border-neutral-100 pb-6">
                          ...
                          <p className="mt-2 text-sm text-neutral-500">Project Details</p>
                        </div>
                        ...
                        <div>
                          ...
                          {errors.scopeOfWork && (
                            <p className="mt-2 text-xs text-red-500">{errors.scopeOfWork.message}</p>
                          )}
                        </div>
                        ...
                        <div className="grid gap-6 sm:grid-cols-2">
                          ...
                          <div>
                            ...
                            <select
                              ...
                              className={`w-full rounded-lg border ${
                                errors.projectStatus ? 'border-red-300' : 'border-neutral-200'
                              } bg-neutral-50 px-4 py-3 text-base font-light text-neutral-950 transition-all focus:border-neutral-400 focus:bg-white focus:outline-none`}
                            >
                          ...
                          <div>
                            ...
                            {watchedValues.location === 'International (Doha/London/Syria)' && (
                              <input
                          ...
                          <div>
                            ...
                            <select
                              {...register('isTender')}
                              className={`w-full rounded-lg border ${
                                errors.isTender ? 'border-red-300' : 'border-neutral-200'
                              } bg-neutral-50 px-4 py-3 text-base font-light text-neutral-950 transition-all focus:border-neutral-400 focus:bg-white focus:outline-none`}
                            >
                              <option value="">Select option</option>
                              <option value="yes">Yes (I have a Tender Package / BOQ)</option>
                              <option value="no">No (Direct Appointment / Design-Build)</option>
                            </select>
                            {errors.isTender && (
                              <p className="mt-1 text-xs text-red-500">{errors.isTender.message}</p>
                            )}
                          </div>
                        </div>
                      </motion.div>
                    ...
                    {currentStep === 3 && (
                      ...
                      >
                        <div className="mb-8 border-b border-neutral-100 pb-6">
                          ...
                          <p className="mt-2 text-sm text-neutral-500">Budget & Style</p>
                        </div>
                        ...
                        <div>
                          ...
                          />
                          {errors.budget && (
                            <p className="mt-2 text-xs text-red-500">{errors.budget.message}</p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          {errors.timeline && (
                            <p className="mt-2 text-xs text-red-500">{errors.timeline.message}</p>
                          )}
                        </div>
            ...
            >
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="flex items-center gap-4 rounded-xl border border-neutral-200 bg-white p-6">
                  ...
                  <div>
                    <h4 className="font-medium text-neutral-950">Non-Disclosure</h4>
                    <p className="text-sm font-light text-neutral-500">
                      All project details are treated with strict confidentiality.
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-4 rounded-xl border border-neutral-200 bg-white p-6">
                  ...
                  <div>
                    <h4 className="font-medium text-neutral-950">No Obligation</h4>
                    <p className="text-sm font-light text-neutral-500">
