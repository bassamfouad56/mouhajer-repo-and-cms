  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute left-0 top-1/3 h-[600px] w-[600px] rounded-full bg-[#8f7852]/[0.03] blur-[150px]" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12">
          ...
          {corporatePartners.map((partner, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative overflow-hidden border border-neutral-200 bg-white p-8 shadow-sm transition-all duration-500 hover:border-[#8f7852]/30 hover:shadow-xl lg:p-12"
              >
                {/* Category Badge */}
                <div className="mb-6 inline-block border border-[#8f7852]/20 bg-[#8f7852]/5 px-4 py-2">
                ...
                <div className="mb-6 flex items-start gap-4">
                  <div className="flex h-16 w-16 shrink-0 items-center justify-center border border-[#8f7852]/30 bg-[#8f7852]/5 transition-all duration-300 group-hover:border-[#8f7852]/50 group-hover:bg-[#8f7852]/10">
                    <Icon className="h-8 w-8 text-[#8f7852]" strokeWidth={1} />
                  </div>
                  <div className="flex-1">
                    <h3 className="mb-2 font-SchnyderS text-2xl font-light text-neutral-950 transition-colors group-hover:text-[#8f7852] lg:text-3xl">
                      {partner.name}
                    </h3>
                ...
                {/* Decorative Elements */}
                <div className="absolute bottom-0 left-0 h-1 w-0 bg-gradient-to-r from-[#8f7852] to-transparent transition-all duration-500 group-hover:w-full" />

                {/* Corner Accents */}
                <div className="absolute right-0 top-0 h-20 w-20 border-r border-t border-neutral-200 transition-colors duration-300 group-hover:border-[#8f7852]/30" />
                <div className="absolute bottom-0 left-0 h-20 w-20 border-b border-l border-neutral-200 transition-colors duration-300 group-hover:border-[#8f7852]/30" />
              </motion.div>
            );
          })}
        </div>
        ...
        <motion.div
          ...
          className="mt-16 border-l-2 border-[#8f7852]/30 bg-neutral-50 p-8 lg:mt-24 lg:p-12"
        >
