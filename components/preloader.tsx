    ...
    <AnimatePresence>
      {isLoading && (
        ...
        >
          ...
          {/* Ambient glow */}
          <motion.div
            className="absolute h-[400px] w-[400px] rounded-full bg-[#d4af37]/[0.05] blur-[150px]"
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.3, 0.5, 0.3],
            }}
          ...
          >
            ...
            <motion.div
              ...
              className="mt-2 h-px w-full origin-left bg-gradient-to-r from-[#d4af37] via-[#d4af37]/50 to-transparent"
            />
          </motion.div>
          ...
          {/* Animated lines */}
          <motion.div
            className="absolute left-[20%] top-1/2 h-px w-20 bg-gradient-to-r from-transparent via-[#d4af37]/20 to-transparent"
