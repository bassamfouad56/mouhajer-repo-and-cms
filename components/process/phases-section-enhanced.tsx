...
function PhaseCard({
  ...
  return (
    <motion.div ref={cardRef} style={{ opacity }} className="relative">
      <div
        className={`grid gap-12 lg:grid-cols-2 lg:gap-20 ${isEven ? "" : "lg:grid-flow-dense"}`}
      >
        {/* Content Side */}
        <motion.div
          style={{ y }}
        ...
        >
          ...
          <div className="space-y-3">
            ...
            >
              ...
              />
              <span
                className="font-Satoshi text-sm font-medium uppercase tracking-wider"
                style={{ color: phase.color }}
              >
                Key Deliverables
              </span>
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <div className="mb-24 text-center lg:mb-32">
          ...
          >
            From discovery to white-glove handover, every phase is designed to
            eliminate risk and maximize value.
          </motion.p>
        </div>
        ...
        >
          ...
          <p className="mb-10 font-Satoshi text-base font-light text-neutral-600">
            Let's discuss how our integrated approach can deliver your next
            project flawlessly.
          </p>
