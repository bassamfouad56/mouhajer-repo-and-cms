...
import { Ear, Palette, Cpu, Package, Hammer, Key, ArrowRight } from 'lucide-react';
      ...
      <div className="relative overflow-hidden bg-neutral-950 py-24 sm:py-32 lg:py-40">
        ...
        >
          ...
          <p className="mb-10 font-Satoshi text-base font-light text-white/70">
            From first sketch to final polish, we orchestrate every detail with precision.
          </p>
  ...
  return (
    <div ref={blockRef} className={`relative overflow-hidden ${phase.bgColor} py-24 sm:py-32 lg:py-40`}>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12">
        <div className={`grid gap-16 lg:grid-cols-2 lg:gap-20 ${!isEven ? 'lg:flex-row-reverse' : ''}`}>
          ...
          >
            ...
            <h3 className={`mb-6 font-SchnyderS text-3xl font-light ${phase.textColor} sm:text-4xl lg:text-5xl`}>
              {phase.headline}
            </h3>

            <p className={`mb-8 font-Satoshi text-base font-light leading-relaxed ${phase.bgColor === 'bg-neutral-100' ? 'text-neutral-600' : 'text-white/70'} lg:text-lg`}>
              {phase.description}
            </p>
            ...
            <div className="space-y-6">
              {phase.points.map((point, i) => (
                ...
                >
                  ...
                  <p className={`font-Satoshi text-sm font-light leading-relaxed ${phase.bgColor === 'bg-neutral-100' ? 'text-neutral-600' : 'text-white/60'}`}>
                    {point.text}
                  </p>
                </motion.div>
              ))}
