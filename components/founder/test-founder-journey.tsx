...
const timeline = [
  {
    ...
    description: 'Studied architecture and engineering in London, absorbing the discipline, precision, and minimalist elegance of European design thinking.',
    image: '',
  },
  {
    id: 'founding',
    ...
    description: 'Founded MIDC with a vision to merge European discipline with Arabian warmth. Started with a small team and one conviction: never compromise on quality.',
    image: '',
  },
  {
    id: 'integration',
    ...
    description: 'Built the first truly integrated design-build firm in the region. United architects, engineers, and craftsmen under one roof—one vision.',
    image: '',
  },
  {
    id: 'recognition',
    ...
    description: 'MIDC receives 12 international awards, including Best Hotel Suite Interior (Arabia) and recognition from the Luxury Lifestyle Awards. The vision has become the standard.',
    image: '',
  },
];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl font-Satoshi text-lg font-light leading-relaxed text-neutral-600">
            Every great legacy has a story. This is how one engineer's belief in bridging cultures became the Middle East's most trusted luxury design firm.
          </p>
        </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className={`flex flex-col justify-center ${isEven ? 'lg:order-1 lg:text-right' : 'lg:order-2'}`}>
                    {/* Icon & Year */}
                    <div className={`mb-6 flex items-center gap-4 ${isEven ? 'lg:justify-end' : ''}`}>
                      <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-[#d4af37]/30 bg-[#d4af37]/5">
                        <Icon className="h-7 w-7 text-[#d4af37]" strokeWidth={1.5} />
                      </div>
                      <div>
                        <div className="font-SchnyderS text-3xl font-light text-[#d4af37]">
                          {item.year}
                        </div>
                    ...
                    {/* Decorative line */}
                    <div className={`mt-6 h-px w-24 bg-[#d4af37] ${isEven ? 'lg:ml-auto' : ''}`} />
                  </div>
                  ...
                  <div className="absolute left-1/2 top-1/2 hidden h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full border-4 border-white bg-[#d4af37] shadow-lg lg:block" />
                </motion.div>
              );
            })}
          </div>
        ...
        >
          <p className="mx-auto max-w-4xl font-SchnyderS text-3xl font-light leading-relaxed text-neutral-950 lg:text-4xl">
            Today, MIDC stands as proof that great design transcends borders. It speaks the language of excellence—universally understood.
          </p>
          <div className="mx-auto mt-12 h-px w-32 bg-[#d4af37]" />
        </motion.div>
