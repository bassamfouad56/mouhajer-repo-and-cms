...
export function StandardsSectionEnhanced() {
  ...
  return (
    ...
    >
      ...
      {/* Gradient orbs */}
      <div className="absolute right-0 top-1/4 h-[600px] w-[600px] translate-x-1/3 rounded-full bg-[#d4af37]/5 blur-[120px]" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12">
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-20 lg:items-center">
          ...
          >
            ...
            >
              <SVGLineDraw width={60} height={1} strokeColor="#d4af37" duration={1.5} delay={0.2} />
            ...
            <div className="mt-8 space-y-3">
              {clients.map((client, index) => (
                ...
                >
                  ...
                  >
                    <CheckCircle2 className="h-5 w-5 flex-shrink-0 text-[#d4af37] transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />
                  </motion.div>
                  <div>
                    <span className="font-SchnyderS text-lg font-light text-neutral-950 transition-colors duration-300 group-hover:text-[#d4af37]">
                      {client.name}
                    </span>
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="absolute left-4 top-4 h-20 w-20 border-l-2 border-t-2 border-[#d4af37]/60"
              />
              <motion.div
                initial={{ scale: 0, rotate: 45 }}
                animate={isInView ? { scale: 1, rotate: 0 } : {}}
                transition={{ duration: 0.6, delay: 0.5 }}
                className="absolute bottom-4 right-4 h-20 w-20 border-b-2 border-r-2 border-[#d4af37]/60"
              />

              {/* SVG Line decorations */}
              <div className="absolute left-4 top-28">
                <SVGLineDraw width={60} height={2} strokeColor="#d4af37" duration={1.2} delay={0.6} />
              </div>
              <div className="absolute bottom-28 right-4">
                <SVGLineDraw width={60} height={2} strokeColor="#d4af37" duration={1.2} delay={0.7} />
              </div>
              ...
              >
                <motion.div
                  ...
                  className="group relative border-l-2 border-[#d4af37] bg-neutral-950/90 p-6 backdrop-blur-md"
                >
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              <MagneticButton strength={0.25}>
                <Link
                  href="/about/awards"
                  className="group inline-flex items-center gap-3 border border-[#d4af37]/30 bg-[#d4af37]/5 px-10 py-5 font-Satoshi text-sm font-light uppercase tracking-wider text-neutral-950 transition-all duration-500 hover:border-[#d4af37]/50 hover:bg-[#d4af37]/10"
                >
