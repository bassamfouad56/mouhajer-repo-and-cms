  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute right-[20%] top-[20%] h-px w-32 bg-gradient-to-r from-transparent via-white/20 to-transparent"
          animate={{ x: [0, 50, 0], opacity: [0.2, 0.5, 0.2] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute left-[10%] top-[60%] h-px w-24 bg-gradient-to-r from-transparent via-white/10 to-transparent"
          animate={{ x: [0, -30, 0], opacity: [0.1, 0.3, 0.1] }}
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 1 }}
        />
        <motion.div
          className="absolute right-[30%] bottom-[30%] h-32 w-px bg-gradient-to-b from-transparent via-white/10 to-transparent"
        ...
        <div className="grid w-full gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          >
            ...
            >
              ...
              <div className="relative aspect-[3/4] overflow-hidden">
                {/* Outer frame */}
                <div className="absolute -inset-4 border border-white/10" style={{ transform: 'translateZ(-20px)' }} />
                ...
                <div className="absolute bottom-0 right-0 h-16 w-16 border-b border-r border-white/20" />
              </div>
          ...
          >
            ...
            >
              ...
              <span className="font-Satoshi text-[10px] font-light uppercase tracking-[0.3em] text-white/40 sm:text-xs">
            ...
            >
              <h2 className="font-SchnyderS text-4xl font-light leading-[1.1] tracking-tight text-white sm:text-5xl lg:text-6xl">
                We Don't Just Draw.
                <br />
                <span className="text-[#d4af37]">We Build.</span>
              </h2>
            </motion.div>
            ...
            <div className="mb-8 sm:mb-12">
              <motion.div
                ...
                className="mb-4 font-SchnyderS text-5xl font-light leading-none text-white/10 sm:text-7xl"
              >
                &ldquo;
              </motion.div>

              <h2 className="font-SchnyderS text-3xl font-light leading-[1.2] tracking-tight text-white sm:text-4xl lg:text-5xl xl:text-6xl">
            ...
            >
              <p className="font-Satoshi text-base font-light leading-relaxed text-white/70 sm:text-lg">
              ...
              <p className="font-Satoshi text-sm font-light leading-relaxed text-white/50 sm:text-base">
            ...
            >
              ...
              <div className="mt-4 flex items-center gap-6">
                <div>
                  ...
                  <div className="font-Satoshi text-[10px] font-light uppercase tracking-[0.2em] text-white/30 sm:text-xs">
                    {founderTitle}
                  </div>
                </div>
                ...
                <div className="hidden sm:block">
                  ...
                  <div className="font-Satoshi text-[10px] font-light uppercase tracking-[0.15em] text-white/20">
      ...
      {/* Mouse follower glow */}
      <motion.div
        className="pointer-events-none fixed h-64 w-64 rounded-full bg-white/[0.02] blur-3xl"
        style={{
