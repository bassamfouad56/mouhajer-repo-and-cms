        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          >
            ...
            <h2 className="mb-8 font-SchnyderS text-4xl font-light leading-[1.1] tracking-tight text-neutral-950 sm:text-5xl lg:text-6xl">
              Growing with
              <br />
              <span className="text-[#d4af37]">the UAE</span>
            </h2>
            ...
            <motion.div
              ...
              className="mt-12 border-l-2 border-[#d4af37] pl-6"
            >
          ...
          >
            <div className="relative aspect-[4/5] overflow-hidden rounded-sm bg-neutral-200">
              ...
              {/* Decorative Frame */}
              <div className="absolute left-4 top-4 h-24 w-24 border-l-2 border-t-2 border-[#d4af37]/30" />
              <div className="absolute bottom-4 right-4 h-24 w-24 border-b-2 border-r-2 border-[#d4af37]/30" />
            </div>
