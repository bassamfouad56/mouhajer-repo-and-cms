          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div>
              ...
              >
                ...
                <Trophy className="h-4 w-4 text-[#8f7852]" strokeWidth={1} />
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {awards.map((award, index) => (
            <motion.div
              ...
              className="group relative border border-neutral-200 bg-white p-8 transition-all duration-300 hover:border-[#8f7852]/30 hover:shadow-lg"
            >
              {/* Year */}
              ...
              {/* Badge */}
              <div className="mb-6 inline-flex items-center gap-2 border border-[#8f7852]/30 bg-[#8f7852]/5 px-3 py-1.5">
                <Award className="h-3 w-3 text-[#8f7852]" strokeWidth={1} />
                <span className="font-Satoshi text-[10px] font-light uppercase tracking-wider text-[#8f7852]">
                  {award.category}
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 border-t border-neutral-100 pt-4">
                <Star className="h-3 w-3 text-[#8f7852]" fill="currentColor" />
              ...
              {/* Hover corner */}
              <div className="absolute bottom-0 right-0 h-12 w-12 border-b border-r border-[#8f7852]/20 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
            </motion.div>
          ))}
        </div>
