...
export const AnimatedButton = forwardRef<HTMLButtonElement, AnimatedButtonProps>(
  (
    ...
    const baseStyles =
      "relative overflow-hidden inline-flex items-center justify-center font-Satoshi font-light uppercase tracking-[0.15em] transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2";

    const variants = {
      primary:
        "bg-neutral-950 text-white border border-neutral-950 hover:bg-transparent hover:text-neutral-950 focus-visible:ring-neutral-950",
      secondary:
        "bg-transparent text-neutral-950 border border-neutral-950 hover:bg-neutral-950 hover:text-white focus-visible:ring-neutral-400",
    };
...
export const IconButton = forwardRef<HTMLButtonElement, IconButtonProps>(
  ({ children, className, size = "md", variant = "primary", ...props }, ref) => {
    ...
    const variants = {
      primary: "bg-neutral-950 text-white border border-neutral-950 hover:bg-transparent hover:text-neutral-950",
      secondary: "bg-transparent text-neutral-950 border border-neutral-950 hover:bg-neutral-950 hover:text-white",
    };
