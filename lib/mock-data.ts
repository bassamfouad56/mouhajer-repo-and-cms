...
export const mockProjects: Project[] = [
  {
    ...
    excerpt: 'Award-winning luxury desert resort featuring 42 private suites with authentic Bedouin-inspired design and sustainable architecture.',
    ...
    acfFields: {
      ...
      projectDescription: 'A transformative luxury hospitality project creating an authentic desert resort experience.',
      gallery: [
        { sourceUrl: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=1200&q=80', altText: 'Luxury Hotel Lobby' },
        { sourceUrl: 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=1200&q=80', altText: 'Desert View Suite' },
        { sourceUrl: 'https://images.unsplash.com/photo-1590490360182-c33d57733427?w=1200&q=80', altText: 'Infinity Pool' },
        { sourceUrl: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=1200&q=80', altText: 'Fine Dining Restaurant' },
      ],
    },
  },
  {
    ...
    excerpt: 'Ultra-modern 800 sqm penthouse with panoramic Burj Khalifa views featuring bespoke design and smart home integration.',
    ...
    acfFields: {
      ...
      projectArea: '800 sqm',
      projectDescription: 'A sophisticated penthouse transformation featuring premium Italian materials and smart home technology.',
      gallery: [
        { sourceUrl: 'https://images.unsplash.com/photo-1600210492493-0946911123ea?w=1200&q=80', altText: 'Modern Living Room' },
        { sourceUrl: 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=1200&q=80', altText: 'Custom Italian Kitchen' },
        { sourceUrl: 'https://images.unsplash.com/photo-1615873968403-89e068629265?w=1200&q=80', altText: 'Master Bedroom Suite' },
      ],
    },
  },
  {
    ...
    excerpt: 'Modern 3,500 sqm corporate headquarters featuring activity-based design, biophilic elements, and LEED Platinum certification.',
    ...
    acfFields: {
      ...
      projectDescription: 'A comprehensive corporate office transformation focusing on employee experience and sustainability.',
      gallery: [
        { sourceUrl: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=1200&q=80', altText: 'Open Plan Workspace' },
        { sourceUrl: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=1200&q=80', altText: 'Collaboration Zone' },
      ],
    },
  },
  {
    ...
    excerpt: '1,200 sqm beachfront villa featuring seamless indoor-outdoor living with infinity pool and private beach access.',
    ...
    featuredImage: {
      node: {
        sourceUrl: 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=1600&q=80',
        altText: 'Beach Villa',
      },
    },
    acfFields: {
      ...
      projectDescription: 'A luxurious beachfront villa emphasizing indoor-outdoor living with marine-grade materials.',
      gallery: [
        { sourceUrl: 'https://images.unsplash.com/photo-1613977257363-707ba9348227?w=1200&q=80', altText: 'Villa Living Room' },
        { sourceUrl: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=1200&q=80', altText: 'Infinity Pool' },
      ],
    },
  },
];
...
export const mockIndustries: Industry[] = [
  {
    ...
    excerpt: 'Creating unforgettable guest experiences through exceptional hotel and resort design.',
    content: `
    ...
    acfFields: {
      shortDescription: 'Transform hotels and resorts into memorable destinations',
      description: 'Specialized in luxury hospitality design including hotels, resorts, restaurants, and wellness facilities.',
      serviceFeatures: [
  ...
  },
  {
    ...
    excerpt: 'Bespoke luxury residential design creating sophisticated homes that reflect your unique lifestyle.',
    content: `
    ...
    acfFields: {
      ...
      description: 'Creating bespoke residential interiors for discerning clients who demand excellence.',
      serviceFeatures: [
  ...
  },
  {
    ...
    excerpt: 'Innovative office design creating productive environments that inspire teams.',
    content: `
    ...
    acfFields: {
      ...
      description: 'Commercial interior design that balances productivity, aesthetics, and employee wellbeing.',
      serviceFeatures: [
  ...
  },
  {
    ...
    slug: 'retail-spaces',
    title: 'Retail Spaces',
    excerpt: 'Innovative retail design that creates engaging shopping experiences and drives sales.',
    content: `
    ...
    featuredImage: {
      node: {
        sourceUrl: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1600&q=80',
        altText: 'Retail Design',
      },
    },
    acfFields: {
      shortDescription: 'Engaging retail environments that drive sales',
      description: 'Creating innovative retail spaces that combine brand storytelling with commercial effectiveness.',
      serviceFeatures: [
...
export const mockServices: Service[] = [
  {
    ...
    excerpt: 'Comprehensive interior design services from concept to completion, creating spaces that inspire and delight.',
    content: `
    ...
    featuredImage: {
      node: {
        sourceUrl: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1600&q=80',
        altText: 'Interior Design',
      },
    },
    acfFields: {
      shortDescription: 'Complete interior design from concept to completion',
      description: 'Full-service interior design creating beautiful, functional spaces tailored to your needs.',
      serviceFeatures: [
      ...
      processSteps: [
        {
          ...
          description: 'We begin by understanding your vision, lifestyle, and requirements through in-depth consultations and site analysis.',
        },
        {
          title: 'Concept Development',
          description: 'Our team creates initial design concepts, mood boards, and spatial layouts that capture your vision.',
        },
        {
          title: 'Design Development',
          description: 'We refine the chosen concept, selecting materials, finishes, furniture, and fixtures to bring the design to life.',
        },
        {
          title: 'Implementation',
          description: 'We oversee the entire installation process, coordinating with contractors and suppliers to ensure flawless execution.',
        },
      ],
      stats: {
  ...
  },
  {
    ...
    excerpt: 'Strategic space planning services optimizing layout and flow for maximum functionality and efficiency.',
    content: `
    ...
    featuredImage: {
      node: {
        sourceUrl: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=1600&q=80',
        altText: 'Space Planning',
      },
    },
    acfFields: {
      shortDescription: 'Optimize layouts for functionality and flow',
      description: 'Professional space planning services to maximize the potential of every area.',
      serviceFeatures: [
      ...
      processSteps: [
        {
          title: 'Site Analysis',
          description: 'We conduct thorough measurements and assess existing conditions, constraints, and opportunities.',
        },
        {
          title: 'Needs Assessment',
          description: 'Understanding how the space will be used and by whom, including activity mapping and user requirements.',
        },
        {
          title: 'Layout Development',
          description: 'Creating multiple layout options with detailed floor plans showing furniture placement and circulation paths.',
        },
        {
          title: 'Refinement & Documentation',
          description: 'Finalizing the optimal layout and producing detailed drawings for implementation.',
        },
      ],
      stats: {
  ...
  },
  {
    ...
    excerpt: 'Bespoke furniture design and fabrication creating unique pieces perfectly tailored to your space.',
    content: `
    ...
    featuredImage: {
      node: {
        sourceUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=1600&q=80',
        altText: 'Custom Furniture',
      },
    },
    acfFields: {
      shortDescription: 'Bespoke furniture pieces for unique spaces',
      description: 'Custom-designed and handcrafted furniture tailored to your exact specifications.',
      serviceFeatures: [
      ...
      processSteps: [
        {
          title: 'Design Brief',
          description: 'We discuss your requirements, style preferences, and functional needs for the custom piece.',
        },
        {
          title: 'Concept & Sketches',
          description: 'Our designers create initial sketches and 3D models showing the proposed design.',
        },
        {
          title: 'Material Selection',
          description: 'Together we select premium materials, finishes, and hardware that align with your vision.',
        },
        {
          title: 'Fabrication & Installation',
          description: 'Master craftsmen build your furniture to exacting standards, then we install it perfectly in your space.',
        },
      ],
      stats: {
  ...
  },
  {
    ...
    excerpt: 'Sophisticated lighting design creating ambiance, enhancing architecture, and improving functionality.',
    content: `
    ...
    featuredImage: {
      node: {
        sourceUrl: 'https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?w=1600&q=80',
        altText: 'Lighting Design',
      },
    },
    acfFields: {
      shortDescription: 'Create atmosphere through expert lighting',
      description: 'Professional lighting design services combining aesthetics with technical precision.',
      serviceFeatures: [
      ...
      processSteps: [
        {
          ...
          description: 'We assess natural light patterns, spatial requirements, and functional needs for each area.',
        },
        {
          title: 'Design Strategy',
          description: 'Developing a comprehensive lighting plan incorporating ambient, task, and accent lighting.',
        },
        {
          title: 'Fixture Selection',
          description: 'Specifying fixtures that complement the design while meeting technical requirements.',
        },
        {
          title: 'Programming & Testing',
          description: 'Setting up lighting scenes and controls, then fine-tuning levels for perfect results.',
        },
      ],
      stats: {
...
export const mockPosts: Post[] = [
  {
    ...
    excerpt: '<p>Explore how interior design has transformed over the decades.</p>',
...
export async function getProjectBySlug(slug: string, _locale: string = 'en'): Promise<Project | null> {
  await new Promise(resolve => setTimeout(resolve, 100));
...
export async function getServiceBySlug(slug: string, _locale: string = 'en'): Promise<Service | null> {
  await new Promise(resolve => setTimeout(resolve, 100));
  // Use real services from WordPress export
  return (realServices as any).find((s: any) => s.slug === slug) || null;
}

export async function getIndustries(_locale: string = 'en'): Promise<Industry[]> {
  await new Promise(resolve => setTimeout(resolve, 100));
...
export async function getPostBySlug(slug: string, _locale: string = 'en'): Promise<Post | null> {
  await new Promise(resolve => setTimeout(resolve, 100));
  // Use real posts
  return (realPosts as any).find((p: any) => p.slug === slug) || null;
}

export async function getCategories(_locale: string = 'en'): Promise<Category[]> {
  return [
