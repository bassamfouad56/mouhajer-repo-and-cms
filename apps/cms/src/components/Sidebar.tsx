  ...
  const navigationGroups: NavigationGroup[] = [
    {
      ...
      items: [
        {
          href: '/analytics/google-integration',
          name: 'Google Hub',
          icon: (
        ...
        {
          href: '/analytics/business-profile',
          name: 'Reviews',
          icon: (
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <nav className="py-4" role="navigation" aria-label="Main navigation">
          <div className="px-3 space-y-1">
                ...
                <div key={group.name} className="mt-2">
                  ...
                  >
                    <div className="flex items-center">
                      <span className={`mr-3 ${hasActiveItem ? 'text-blue-700 dark:text-blue-400' : 'text-gray-400 dark:text-gray-500'}`}>
                        {group.icon}
                      </span>
                    ...
                    <div className="mt-1 ml-4 pl-4 border-l-2 border-gray-200 dark:border-gray-700 space-y-1">
                      {group.items.map((item) => {
                        ...
                        return (
                          ...
                          >
                            <span className={`mr-2 ${isActive ? 'text-blue-700 dark:text-blue-400' : 'text-gray-400 dark:text-gray-500'}`}>
                              {item.icon}
                            </span>
                            {item.name}
                          </Link>
            ...
            <Link
              href="/settings"
              onClick={closeMobileMenu}
              className={`group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all mt-2 ${
                pathname === '/settings' || pathname.startsWith('/settings/')
                  ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 shadow-sm'
                  : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'
              }`}
            >
              <svg className={`mr-3 h-5 w-5 ${pathname === '/settings' || pathname.startsWith('/settings/') ? 'text-blue-700 dark:text-blue-400' : 'text-gray-400 dark:text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
