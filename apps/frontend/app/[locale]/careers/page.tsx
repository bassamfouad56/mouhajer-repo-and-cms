...
import VacencyGrid from "@/components/VacencyGrid";
...
const page = async ({ params }: Props) => {
  ...
  // Fetch CMS page data for careers page
  let pageData;
  try {
    pageData = await cmsClient.getPageBySlug('careers', locale);
  } catch (error) {
