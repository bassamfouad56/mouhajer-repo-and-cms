...
const AboutFounder = ({ founderImage }: Props) => {
  ...
  return (
    <div className="bg-[#F2F1E5]">
      <div className="pt-[16rem] 2xl:pt-[40rem] 2xl:pr-[19.5rem] 2xl:py-[12rem] pb-14 2xl:pb-0">
        <div className="2xl:pl-[13.5rem] mx-auto">
          <div className="grid lg:grid-cols-12 2xl:min-h-[60rem] lg:translate-x-[15%]">
            <div className="min-h-[24rem] sm:min-h-[55rem] lg:min-h-0 w-screen lg:w-full  lg:col-span-5 relative ">
              <Image
            ...
            <div className="col-span-5 text-[#2C2B2B] relative px-12 mt-12">
              <p className="uppercase font-Satoshi mb-[3rem] 2xl:mb-[6rem]">
                {local === "en"
